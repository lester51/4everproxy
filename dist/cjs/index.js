...
var _this = this;
var cheerio = require('cheerio'), request = require('request'), qs = require('querystring');
module.exports.proxy = function (data, jar) {
...
module.exports.getObjectByLocation = function (el, array) {
